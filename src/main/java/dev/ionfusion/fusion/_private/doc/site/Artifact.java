...
/**
 * Represents a physical artifact to be produced during site generation. It ties an entity to a file
 * and a generator that can produce it.
 *
 * @param <E> the type of entity used to generate the artifact.
 */
public class Artifact <E>
{
     ...
     */
    public Artifact(E entity, Path path)
    {
        if (path.isAbsolute())
        {
