...
public class SiteBuilder
{
        ...
        throws FusionException
    {
        MustacheTemplate<ModuleEntity> template =
            new MustacheTemplate<>("src/doc/layouts/module.html");
    ...
    public void placeArticles(Path fromDir, Path toDir)
    {
        ...
        MustacheTemplate<MarkdownArticle> template =
            new MustacheTemplate<>("src/doc/layouts/article.html");
        ...
        throws FusionException
    {
        ...
        MustacheTemplate<PermutedIndex> permuTemplate =
            new MustacheTemplate<>("src/doc/layouts/permuted-index.html");
